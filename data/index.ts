...
export const gridItems = [
  ...
  },
  {
    id: 3,
    title: "My tech stack",
    description: "I'm passionate about learning new technology.",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
  ...
  {
    id: 4,
    title: "Enthusiastic about technology and passionate about development.",
    description: "",
  ...
  {
    id: 5,
    title: "Excited to work in a collaborative team setting.",
    description: "",
  ...
  {
    id: 6,
    title: "If you want to share any advice or idea?",
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
...
export const projects = [
  {
    id: 1,
    title: "Zoom-clone",
    des: "My online video conferencing app offers high-definition video and crystal-clear audio. Take a dive into here and explore ",
    img: "/project3.png",
    iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/stream.svg", "/c.svg"],
    link: "https://zoom-clone-two-silk.vercel.app/",
  },
  {
    id: 2,
...
export const testimonials = [
  ...
  {
    quote:
    "Working with Harun on the creation of a video conferencing app was an exceptional experience. Harun expertly guided the project from planning and strategy through to testing and deployment, ensuring every detail was meticulously handled.",
  name: "Kamal hossain",
  title: '',
  },
];
...
export const workExperience = [
  ...
  },
  {
    ...
    desc: "Proficient in Microsoft Office suite (Word, Excel, PowerPoint) for document creation, data analysis, and presentations.",
    className: "md:col-span-2",
    thumbnail: "/exp2.svg",
  },
  // {
